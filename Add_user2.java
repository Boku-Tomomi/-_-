...
public class Add_user2 {
	public void addUser() {
		try {
			...
			System.out.println("西暦（例：2001）：");
			String year_str = scanner.nextLine();
			
			System.out.println("月（例：01）：");
			String month_str = scanner.nextLine();
			
			System.out.println("日（例：05）：");
			String day_str = scanner.nextLine();
			
			//生年月日はSTR型のままでMySQLに追加可能
			...
			while(rs2.next()){
				...
				System.out.println("以下の内容で登録を完了しました。");
				System.out.print("\nID：");
